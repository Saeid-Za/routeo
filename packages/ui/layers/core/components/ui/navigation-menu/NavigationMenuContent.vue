...
const { class: rawClass, ...props } = defineProps<NavigationMenuContentProps & { class?: HTMLAttributes["class"] }>()
...
const className = useClass(
	"start-0 top-0 w-full data-[motion^=from-]:animate-in data-[motion^=to-]:animate-out data-[motion^=from-]:fade-in",
	...
	"p-2 pe-2.5 group-data-[viewport=false]/navigation-menu:bg-popover group-data-[viewport=false]/navigation-menu:text-popover-foreground",
